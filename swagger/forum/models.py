...
class ForumTop(models.Model):
    forumTitle = models.ForeignKey(ForumTitle, on_delete=models.CASCADE, verbose_name="Раздел", related_name="forumTitle")
    name = models.CharField("Название", max_length = 50)
    ...
    def counter(self, *args, **kwargs):
        self.post_count = self.forumtop.all().count() + 1
...
class ForumMiddle(models.Model):
    forumTop = models.ForeignKey(ForumTop, on_delete=models.CASCADE, verbose_name="Тема", related_name="forumtop")
    name = models.CharField("Название", max_length = 50)
    ...
    def counter(self, *args, **kwargs):
        self.post_count = self.forummiddle.all().count() + 1
        super().save(*args, **kwargs)
...
class ForumMessage(models.Model):
    forumMiddle = models.ForeignKey(ForumMiddle, on_delete=models.CASCADE, verbose_name="Подтема", related_name="forummiddle")

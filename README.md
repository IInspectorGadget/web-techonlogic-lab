...
На сайте имеется регистрация, возможность добовлять в друзья, также имеется форум, к новостями можно оставлять комментарии, имеется система оценки новостей и комментариев. Имеется возможность рассылать уведомления пользователям по почте.

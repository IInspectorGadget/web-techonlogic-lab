...
class CustomIndexDashboard(Dashboard):
    ...
    def init_with_context(self, context):
        ...
        self.children.append(modules.ModelList(
            ...
            models=('userProfile.models.User','django.contrib.*','userProfile.models.Chat', 'userProfile.models.Message', 'userProfile.models.FriendRequest', 'myEmail.models.EmailMessage')
        ))
